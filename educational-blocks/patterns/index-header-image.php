 ...
 * Slug: educational-blocks/index-header-image
 * Categories: educational-blocks, index-header-image
 */
?>
...
<h2 class="wp-block-heading has-text-align-center" style="text-transform:uppercase"><?php echo esc_html__('blog','educational-blocks'); ?></h2>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->